...
| ------------------- | ---------------- | ------------- | ------------- |
| SQL/2023 | [When Was the Golden Age of Video Games?](https://github.com/PMenaM/Projects/blob/main/When%20Was%20the%20Golden%20Age%20of%20Video%20Games%20(Jupyter%20notebook)/When%20Was%20the%20Golden%20Age%20of%20Video%20Games%20(Jupyter%20notebook).ipynb) |  | Функции (COUNT, AVG, ROUND) Операции соединения (JOIN), set theory (EXCEPT, INTERSECT) |
